...
The CiscoSpark Connector facilitates connections between Anypoint Studio and Cisco Spark Application. Cisco Spark Application brings teams together instantly in rooms where they can send messages, video chat, and share files, all in one place.
...
The Cisco Spark Connector 1.0 allows you to perform the following actions:
