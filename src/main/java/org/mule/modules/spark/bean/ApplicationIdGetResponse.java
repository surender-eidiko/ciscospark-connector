...
public class ApplicationIdGetResponse extends StatusResponse {
    ...
    /**
     * A URL reference for the application logo. The logo must be 
     * dimensions. Supported media types are . (Required)
     *
     */
    private String logo;
    /**
     ...
     *  for details about authentication and OAuth flows. (Required)
     *
     */
     ...
     *  for details about authentication, scopes, and OAuth flows.
     * (Required)
     *
     */
     ...
     *  API for how to generate a new client secret. (Required)
     *
     */
