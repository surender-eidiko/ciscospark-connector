...
public class MembershipsIdPutResponse extends StatusResponse {
  ...
  public String toString() {
    return "MembershipsIdPutResponse [id=" + getId() + ", roomId=" + getRoomId() + ", personId=" + getPersonId() + ", personEmail=" + getPersonEmail() + ", isModerator=" + isIsModerator()
      + ", isMonitor=" + isIsMonitor() + ", created=" + getCreated() + ", additionalProperties=" + getAdditionalProperties() + "]";
  }
